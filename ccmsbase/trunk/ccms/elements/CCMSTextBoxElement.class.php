...
/** 
* @file CCMSTextBoxElement.class.php
* The textbox element.
* @see CCMSElements
*/
...
* To input a single line of text. The HTML &lt;INPUT type="text"&gt; tag...
*/

class CCMSTextBoxElement extends CCMSBaseElement
{
	/**
	* XML settigns storage.
	* $settings['editclass'] = Textbox CCS Style in editmode.<br>
	* $settings['showclass'] = Textbox CCS Style in showmode.<br>  
	*/            
	...
	*/  
	public function editmode($name, $val)
	{
		...
		$editbox .= " value=\"".htmlspecialchars($val)."\" />\n";
